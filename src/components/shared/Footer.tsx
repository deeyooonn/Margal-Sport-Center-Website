    ...
    <footer className="bg-card border-t border-border mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {/* Brand */}
          <div>
            <Link href="/" className="flex items-center gap-2.5 font-bold text-sm uppercase tracking-widest text-foreground mb-3">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed mb-5">
              Your Game, Your Rules! No waiting. No strangers. Just pure game time.
            </p>
          ...
          {/* Contact */}
          <div>
            <h3 className="text-xs font-bold uppercase tracking-widest text-muted-foreground mb-4">Visit Us</h3>
        ...
        <div className="mt-10 pt-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-muted-foreground">
          <span>© {new Date().getFullYear()} Margal Sports Center. All rights reserved.</span>
